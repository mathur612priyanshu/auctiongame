...
class GroupAuctionWidgetOptimized extends StatefulWidget {
  final String? currentUserId;
  final Future<void> Function() onRefresh;

  const GroupAuctionWidgetOptimized({
    super.key,
    this.currentUserId,
  ...
  @override
  State<GroupAuctionWidgetOptimized> createState() =>
      _GroupAuctionWidgetOptimizedState();
}

class _GroupAuctionWidgetOptimizedState
    extends State<GroupAuctionWidgetOptimized>
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            ElevatedButton(
              onPressed: _fetchPlayerGroupsOptimized,
